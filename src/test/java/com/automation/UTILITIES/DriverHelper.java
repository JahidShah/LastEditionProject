...
public final class DriverHelper {
	...
	public DriverHelper ( WebDriver driver ) { this.driver = driver; }
...
//        Reporter.step.info("Clicked on element");
    ...
    public void clickByCss (String css, int timeOutInSeconds) {
    	getElement(By.cssSelector(css), timeOutInSeconds).click();
    }
    
    public void clickByClassname (String classname, int timeOutInSeconds ) {
    	getElement(By.className(classname), timeOutInSeconds).click();
    }
    
    public void clickByTagname (String tagname, int timeOutInSeconds ) {
    	getElement(By.tagName(tagname), timeOutInSeconds).click();
    }
    
    public void clickByName (String name, int timeOutInSeconds ) {
    	getElement(By.name(name), timeOutInSeconds).click();
    }
    
    public void clickByLink (String linktext, int timeOutInSeconds ) {
    	getElement(By.linkText(linktext), timeOutInSeconds).click();
    }
    ...
    public void sendKeysById ( By by, String text, int timeOutInSeconds ) {
        getElement(by.id(""), timeOutInSeconds).sendKeys(text);
    }
    
    public void sendKeysByXpath ( By by, String text, int timeOutInSeconds ) {
        getElement(by.xpath(""), timeOutInSeconds).sendKeys(text);
    }
    
    public void sendKeysByCss ( By by, String text, int timeOutInSeconds ) {
        getElement(by.cssSelector(""), timeOutInSeconds).sendKeys(text);
    }
    
    public void sendKeysByTagName ( By by, String text, int timeOutInSeconds ) {
        getElement(by.tagName(""), timeOutInSeconds).sendKeys(text);
    }
    
    public void sendKeysByClassName ( By by, String text, int timeOutInSeconds ) {
        getElement(by.className(""), timeOutInSeconds).sendKeys(text);
    }
    
    public void sendKeysByLinkText ( By by, String text, int timeOutInSeconds ) {
        getElement(by.linkText(""), timeOutInSeconds).sendKeys(text);
    }
    
    public void sendKeysByName ( By by, String text, int timeOutInSeconds ) {
        getElement(by.name(""), timeOutInSeconds).sendKeys(text);
    }
